...
export function LoginPage({ onLogin, onShowTerms, onShowPrivacy }: LoginPageProps) {
    ...
    const handleLogin = (provider: string) => {
        if (provider !== 'demo' && !agreedToTerms) {
            return;
        }
            ...
            <div className="z-10 w-full max-w-md px-4">
                ...
                <Card className="border-border/50 shadow-xl backdrop-blur-sm bg-card/95">
                    <CardHeader className="space-y-1 text-center pb-4">
                        <CardTitle className="text-2xl font-bold">Limpe sua caixa de entrada</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="flex items-center gap-2 text-xs text-muted-foreground justify-center">
                            ...
                            <span>Seus dados estão seguros. Nunca vendemos informações.</span>
                        </div>
                        ...
                        >
                            ...
                            {isLoading === 'google' ? <Loader2 className="h-5 w-5 animate-spin" /> : 'Continuar com Google'}
                        </Button>
                        ...
                        >
                            ...
                            {isLoading === 'microsoft' ? <Loader2 className="h-5 w-5 animate-spin" /> : 'Continuar com Hotmail'}
                        </Button>
                    </CardContent>
                ...
                <p className="text-center text-sm text-muted-foreground mt-8">
                    &copy; 2026 Ratel. Todos os direitos reservados.
                </p>
            </div>
        </div>
    );
