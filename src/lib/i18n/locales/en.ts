export const en = {
    ...
    landing: {
        ...
        features: {
            ...
            card_4_title: 'Delete All',
            card_4_desc: 'No more searching for hidden links. When the mess is too big, use mass unsubscribe! Cancel dozens of subscriptions at once. Reclaim control.',
    ...
    dashboard: {
        demo_mode: 'Demo Mode',
        in_inbox: 'in inbox',
        inbox_zero_progress: 'Inbox Zero Progress',
        ...
        quick_actions: {
            ...
            delete_all: { title: 'Delete All', desc: 'Mass unsubscribe' },
    ...
    protection_page: {
        ...
        description: 'Manage blocks, safe senders, and Ratel intelligence in your inbox.',
        threats_blocked: 'Threats Blocked',
        safe_senders: 'Safe Senders',
        marked_important: 'Marked Important',
        tab_blocked: 'Blocked (Shield)',
        tab_safe: 'Safe Senders',
        tab_important: 'Important (AI)',
        no_safe_sender: 'No safe senders',
        no_safe_sender_desc: 'Mark emails as safe so they never end up in spam or shield.',
        no_important_email: 'No emails marked as important',
        no_important_email_desc: 'AI classifies your emails with a score. You decide which ones are important.',
        safe: 'Safe',
        remove: 'Remove',
        block: 'Block',
        not_important: 'Not Important',
        rule_removed: 'Block rule removed',
        error_removing: 'Error removing rule',
        blocked_added: 'blocked and added to Shield',
        error_blocking: 'Error blocking sender',
        removed_from_safe: 'Removed from safe senders',
        marked_not_important: 'Marked as not important'
    }
};
